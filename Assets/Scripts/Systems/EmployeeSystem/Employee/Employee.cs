...
public class Employee
{
    ...
    /// <summary>
    /// Получить пакет с сообщением о максимальном стрессе
    /// </summary>
    /// <returns>Пакет с сообщением</returns>
    public MessagePanelPack GetMaxStressPack()
    {
        MessagePanelPack pack = new()
        {
            Header = Name + " увольняется",
    ...
    /// <summary>
    /// Получить пакет с сообщением о максимальной усталости
    /// </summary>
    /// <returns>Пакет с сообщением</returns>

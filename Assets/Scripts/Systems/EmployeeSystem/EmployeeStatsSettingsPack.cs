...
{
    [Tooltip("Стандартная скорость выполнения задач")]
    public int baseTaskWorkSpeed = 1;
    [Tooltip("Стандартная скорость тестирования задач")]
...
{
    /// <summary>
    /// Стандартная скорость выполнения задач
    /// </summary>
    public static int baseTaskWorkSpeed = 1;
    /// <summary>
    /// Стандартная скорость тестирования задач
    /// </summary>
